...
public class GlitchOverlay {
    ...
    public static void renderOverlayContent(DrawContext drawContext) {
        ...
        String overlayText = Text.translatable("chunk.toast.lowDiskSpace").getString() + " " + Text.translatable("chunk.toast.lowDiskSpace.description").getString();
        drawContext.drawTextWithShadow(textRenderer, overlayText, 250, 100, 0xFFFFFF);
    }
}