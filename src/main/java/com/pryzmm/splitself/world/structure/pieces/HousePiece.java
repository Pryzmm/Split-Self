...
public class HousePiece extends SimpleStructurePiece {
    public static final String PIECE = "es_house";
    ...
    public HousePiece(StructureTemplateManager manager, BlockPos pos) {
        super(StructurePieces.HOUSE, 0, manager, TEMPLATE_ID,
        ...
        try {
            ...
            SplitSelf.LOGGER.error("Failed to read house template size: {}", e.getMessage());
        }
    }

    public HousePiece(StructureTemplateManager manager, NbtCompound nbt) {
        super(StructurePieces.HOUSE, nbt, manager, id -> createPlacementData());
    }
